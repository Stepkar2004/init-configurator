...
How to think here, never how to do a task. Task knowledge lives in skills; this file
stays thin because it is the one file always loaded in full.

On session start: read `G:\PythonProjects\_for_me\The Brain v2\knowledge\projects\init-configurator.md`
(machine-local brain note), then `docs/state/now.md`. Cold start order:
